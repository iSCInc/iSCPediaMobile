...
echo "iSC Pedia Mobile is a collaborative project released under the 
...
== Included external works ==iSC Pedia Mobile builds upon many Open Source works including:
