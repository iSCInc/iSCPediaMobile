...
public class iSCPediaApp extends Application {
	...
	private void migrateDatabaseFromvc1() {
		...
		File v1File = new File("/data/data/isc.pedia/databases/savedPagesDB.db");
		File v10File = new File("/data/data/isc.pedia/app_database:savedPagesDB.db");
		if(!v1File.exists()) {
