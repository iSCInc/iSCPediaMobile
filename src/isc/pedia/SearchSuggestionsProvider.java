...
public class SearchSuggestionsProvider extends ContentProvider {
	private static final String AUTHORITY = "org.iscpedia.searchsuggestions";
	...
	private String getDefaultLanguage() {
		...
		// Takes default system language, and does minor fixes so that they match the languages isc pedia uses
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
		...
		try {
			...
			String content = HttpApi.getContent("http://" + lang + ".pedia.isc/w/api.php?action=opensearch&limit=10&namespace=0&format=json&search=" + URLEncoder.encode(query, "UTF-8"));
			...
			for (int i = 0; i < lenght; i++) {
				...
				String[] row = { String.valueOf(i), suggestion, "http://" + lang + ".m.pedia.isc/wiki/" + suggestion };
				cursor.addRow(row);
			}
			return cursor;
		} catch (Exception e) {
